...
//	}
	 ...
	 */
	public List<Article> findAll(){
		String sql = "select id,title,name,prefecture,content,post_date,image_path,trip_start_date,trip_end_date,transportation,fare,hotel_name,hotel fee,meal_fee,other_amount,total_fee,good from articles order by id desc";
	...
	public List<Article> findByTitle(String title){
		String sql = "select id,title,name,prefecture,content,post_date,image_path,trip_start_date,trip_end_date,transportation,fare,hotel_name,hotel fee,meal_fee,other_amount,total_fee,goodfrom articles where title Ilike :title";
	...
	public List<Article> findByName(String name){
		String sql = "select id,title,name,prefecture,content,post_date,image_path,trip_start_date,trip_end_date,transportation,fare,hotel_name,hotel fee,meal_fee,other_amount,total_fee,goodfrom articles where name Ilike :name";
	...
	public List<Article> findByContent(String content){
		String sql = "select id,title,name,prefecture,content,post_date,image_path,trip_start_date,trip_end_date,transportation,fare,hotel_name,hotel fee,meal_fee,other_amount,total_fee,good from articles where content Ilike :content";
	...
	public Article load(Integer id) {
		...
		String sql = "select id,title,name,prefecture,content,post_date,image_path,trip_start_date,trip_end_date,transportation,fare,hotel_name,hotel fee,meal_fee,other_amount,total_fee,goodfrom articles where id =:id";
	...
	public void insert(Article article) {
		String sql = "insert into articles(title,name,prefecture,content,post_date,image_path,trip_start_date,trip_end_date,transportation,fare,hotel_name,hotel fee,meal_fee,other_amount,total_fee,good)values(:title,:name,:prefecture,:content,:postDate,:imagePath,:tripStartDate,:tripEndDate,:transportation,:fare,:hotelName,:hotelFee,:mealFee,:otherAmount,:totalFee,:good)";
